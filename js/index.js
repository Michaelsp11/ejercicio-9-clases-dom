...
const pintaPersonajes = () => {
  ...
  for (const personaje of arrayPersonajes) {
    ...
    edadPersonaje.textContent = `Edad: ${edad} años`;
    if (vivo) {
      elementoPersonaje
...
const botonElementoMorir = document.querySelector(".btn-muerte");
const imagenParaGirar = document.querySelector(".girando");
botonElementoMorir.addEventListener("click", () => {
  imagenParaGirar.classList.add("girando");
});
